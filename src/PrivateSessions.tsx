...
export default function PrivateSessions() {
  const { clients, privateSessions, addPrivateSession, updatePrivateSession, updateClient, users } = useAppContext();
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={newSessionTrainerId} onValueChange={setNewSessionTrainerId}>
                <SelectTrigger>
